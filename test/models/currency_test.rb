...
class CurrencyTest < ActiveSupport::TestCase
  ...
  test "symbol should match format" do
    ...
    # Test too short (invalid) - needs at least 3 characters
    currency.symbol = "BT"
    assert_not currency.valid?
    
    # Test valid format - 3 characters
    currency.symbol = "BTC"
    assert currency.valid?
    
    # Test valid format - 6 characters
    currency.symbol = "BTCAUD"
    assert currency.valid?
    
    # Test too long (invalid) - more than 10 characters
  ...
  test "btc class method should find Bitcoin" do
  ...
  test "eth class method should find Ethereum" do
    # Clear existing data to avoid conflicts
    Currency.destroy_all
    btc = Currency.create!(name: "Bitcoin", symbol: "BTCAUD")
    eth = Currency.create!(name: "Ethereum", symbol: "ETHAUD")
    
    assert_equal eth, Currency.eth
  end
